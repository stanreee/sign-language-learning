...
\multirow{2}{0.3\textwidth}{Hardware-Hiding Module} & Video Input Module\\
& Hand Sign Recognition Module\\
\midrule

\multirow{4}{0.3\textwidth}{Behaviour-Hiding Module} & Data Collection Module\\
& Data Processing Module\\
& Testing and Verification Module\\
& Machine Learning Module\\
\midrule

\multirow{2}{0.3\textwidth}{Software Decision Module} & Controller Module\\
...
\subsubsection{Video Input Module (\mref{mHH})}
\begin{description}
...
\subsubsection{Data Collection Module (\mref{mInput})}
...
\subsubsection{Data Processing Module (\mref{mInput})}
\begin{description}
...
\subsubsection{Testing and Verification Module (\mref{mInput})}
\begin{description}
...
\subsubsection{Machine Learning Module (\mref{mInput})}
\begin{description}

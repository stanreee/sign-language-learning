...
letters_to_process = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'k', 'l']

image_path = cur_dir + "/datasets/train/images/"
image_gens = cur_dir + "/datasets/anchors/"
image_data = cur_dir + "/datasets/train/csv/"

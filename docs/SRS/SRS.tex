...
\begin{table}[H]
  ...
  \includegraphics[scale=1]{SRS Traceability Matrix.PNG}
...
%PR5 & The system should be able to host ??? users at one time. & If there are many people who want to learn ASL at the same time they should be able to do so. & \\
\bottomrule
\end{tabular}
\end{table}

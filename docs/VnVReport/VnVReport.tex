...
Automated testing is taken care of by the automatic linter flake8 upon every push to the repository. Currently a couple files are failing to meet the coding standard but these will be taken of upon Rev1. 

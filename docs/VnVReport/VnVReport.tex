...
\caption{System Tests for Performance} \\
\hline
\textbf{Test ID} & \textbf{Test Name} & \textbf{Input} & \textbf{Expected Output} & \textbf{Actual Output} & \textbf{Result} & \textbf{Req ID}\\
\hline
UT-WS1 & test\_dynamic \_event & The system initializes a mock client and it sends dynamic hand sign landmark history back to the system. & The system should be able to successfully process the data and return the sign the data corresponds to. &  &  &  \\
\hline
UT-WS2 & test\_stream \_event & The system initializes a mock client and it sends landmark features back to the system. & The system should be able to successfully process the data and return the sign the data corresponds to. &  &  &  \\
\bottomrule
\end{longtable}

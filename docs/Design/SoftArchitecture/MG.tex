...
Apr 4, 2024 & 2.2 & Jeremy and Cassidy; Added in Quiz Creation Module and updates UsesHierarchy figure \\
\bottomrule
\end{tabularx}
...
\item[\refstepcounter{acnum} \actheacnum \label{acExercise}:] Exercise and Exercise Selection module may change if developers want to add in additional testing methods or material.
...
\item [\refstepcounter{mnum} \mthemnum \label{m11}:] Exercise Selection Module
\item [\refstepcounter{mnum} \mthemnum \label{m12}:] Quiz Generation Module
\end{description}
